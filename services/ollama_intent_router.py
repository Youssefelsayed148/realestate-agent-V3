# services/ollama_intent_router.py
...
class OllamaIntentRouter:
    """
    Local intent/entity extraction using Ollama.
    Uses /api/chat. Default endpoint: http://127.0.0.1:11434
    """
...
""".strip()
    ...
    def _extract_json(self, text: str) -> Dict[str, Any]:
        ...
        return {"intent": "general_question", "entities": {}, "missing_slots": [], "confidence": 0.3}
    ...
    def _text_implies_max_budget(self, text: str) -> bool:
        t = text.lower()
        triggers = [
            "under", "max", "maximum", "at most", "less than", "below",
            "أقل من", "بحد أقصى", "حد أقصى",
        ]
